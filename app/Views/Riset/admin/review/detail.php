                ...
                <?php endif; ?>
                    ...
                    <?php if ($data['status'] == 'selesai'): ?>
                        <div class="text-center py-4">
                            ...
                            <a href="<?= base_url('riset/admin/review/print/' . $data['id']) ?>" target="_blank" class="btn btn-primary w-100 py-2 mb-3 fw-bold shadow-sm" style="font-size: 12px; border-radius: 8px;">
                            ...
                            <form action="<?= base_url('riset/admin/review/uploadSuratIzin') ?>" method="post" enctype="multipart/form-data" class="mt-3 text-start border border-success p-3 rounded-3 bg-light">
                                <input type="hidden" name="id" value="<?= esc($data['id']) ?>">
