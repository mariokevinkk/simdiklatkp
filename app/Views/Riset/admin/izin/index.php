...
<div class="card shadow-sm border-0 rounded-4 bg-white">
    <div class="card-header bg-transparent border-bottom border-light py-3 px-4 d-flex justify-content-between align-items-center">
        <h6 class="mb-0 fw-bold text-dark" style="font-size: 15px;">Daftar Pengajuan Izin Penelitian</h6>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 border-white">
                ...
                <tbody>
                    <?php if (empty($daftar)): ?>
                    <tr>
                        <td colspan="7" class="text-center py-4 text-muted border-light" style="font-size: 13px;">Belum ada pengajuan Izin Penelitian.</td>
                    </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="border-light"><span class="badge bg-white text-danger border border-danger rounded-pill fw-medium" style="font-size: 11px; padding: 6px 12px;">Izin Penelitian</span></td>
                            <td class="border-light">
                            ...
                            <td class="pe-4 text-center border-light text-nowrap">
                                <a href="<?= base_url('riset/admin/izin/detail/' . $p['id']) ?>" class="btn btn-sm btn-outline-danger rounded-pill shadow-sm fw-bold px-3 py-1" style="font-size: 11px;">
