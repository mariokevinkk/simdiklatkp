    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 text-center">
            ...
            ?>
                ...
                <a href="<?= base_url('riset/peneliti/pengajuan/izin/print/' . $data['id']) ?>" target="_blank" class="btn btn-success w-100 rounded-pill fw-bold shadow-sm" style="font-size: 12px; background: #2e7d32; border-color: #2e7d32;">
