...
<div class="card border-0 shadow-sm rounded-lg overflow-hidden mb-4">
    <div class="card-header bg-dark text-white py-3 px-4 d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-sm btn-outline-light rounded-pill px-3 fw-bold" onclick="showModalTambah('<?= esc($ranah) ?>')">
                <i class="fas fa-plus me-1"></i> Tambah Kategori
            </button>
            <button class="btn btn-sm btn-warning rounded-pill px-3 fw-bold text-dark" onclick="showModalEditRanah('<?= esc($ranah, 'js') ?>')">
                <i class="fas fa-edit me-1"></i> Edit Ranah
            </button>
            <button class="btn btn-sm btn-danger rounded-pill px-3 fw-bold" onclick="confirmHapusRanah('<?= esc($ranah, 'js') ?>', <?= count($items) ?>)">
