        ...
        <div class="col-lg-4">
            <div class="profile-card mb-4">
                ...
                <div class="text-center px-4">
                    <h5 class="fw-bold mb-1"><?= $user['nama_lengkap'] ?? 'Admin' ?></h5>
                    <p class="opacity-75 small text-muted mb-0"><?= $user['nama_profesi'] ?? 'Admin Diklat' ?> • <?= $user['nama_unit'] ?? 'RSUD Kota Yogyakarta' ?></p>
                </div>
