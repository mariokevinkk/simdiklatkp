...
public function ciApiList()
    ...
    public function ciApiUpdate($id)
    {
        ...
        try {
            $updateData = [];
            if (isset($input->nama_lengkap)) $updateData['nama_lengkap'] = $input->nama_lengkap;
            else if (isset($input->name)) $updateData['nama_lengkap'] = $input->name;
            if (property_exists($input, 'id_profesi')) $updateData['id_profesi'] = $input->id_profesi ?: null;
            if (isset($input->nip)) $updateData['nip'] = $input->nip;
            if (property_exists($input, 'id_unit_kerja')) $updateData['id_unit_kerja'] = $input->id_unit_kerja ?: null;
            if (isset($input->nomor_telepon)) $updateData['nomor_telepon'] = $input->nomor_telepon;
            else if (isset($input->contact)) $updateData['nomor_telepon'] = $input->contact;
            ...
            $userUpdate = [];
            if (!empty($input->email)) $userUpdate['email'] = $input->email;
